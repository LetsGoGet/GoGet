...
if ( ! defined( 'ABSPATH' ) ) { exit; }
 ...
 foreach ( $site_view_params as $view_params ) { fs_require_template( 'account/partials/site.php', $view_params ); } ?>
						...
						<?php
 $account_addons = $fs->get_updated_account_addons(); $installed_addons = $fs->get_installed_addons(); $installed_addons_ids = array(); foreach ( $installed_addons as $fs_addon ) { $installed_addons_ids[] = $fs_addon->get_id(); } $addons_to_show = array_unique( array_merge( $installed_addons_ids, $account_addons ) ); ?>

...
<div class="fs-modal fs-modal-auto-install">
	<div class="fs-modal-dialog">
		...
		<div class="fs-modal-body">
			...
			<?php else : ?>
				<p class="fs-installation-notice"><?php echo sprintf( fs_esc_html_inline( 'An automated download and installation of %s (paid version) from %s will start in %s. If you would like to do it manually - click the cancellation button now.', 'installing-in-n', $slug ), $plugin_title, sprintf( '<a href="%s" target="_blank">%s</a>', 'https://freemius.com', 'freemius.com' ), $countdown_html ) ?></p>
			<?php endif ?>
